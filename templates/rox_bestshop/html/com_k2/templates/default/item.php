 ...
 <?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
  ...
  <div class="itemComments">
	...
	<div class="clr"></div>
	  ...
	  <!-- Item user comments -->
	  <h3 class="itemCommentsCounter"><?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?> (<span><?php echo $this->item->numOfComments; ?></span>)
	  </h3>
