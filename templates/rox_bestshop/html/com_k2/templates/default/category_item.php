...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="catItemHeader">
		...
		<div class="catItemHitsBlock">
			<span class="catItemHits">
				<?php echo JText::_('Hits :'); ?> <b><?php echo $this->item->hits; ?></b> <?php echo JText::_(''); ?>
			</span>
		</div>
		<?php endif; ?>
		<div class="clr"></div>
  ...
  <div class="clr"></div>
	...
	<div class="catItemReadMore">
		<a class="k2ReadMore button subbutton btn btn-primary" href="<?php echo $this->item->link; ?>">
	...
	<div class="catItemCommentsLink">
		...
		<?php endif; ?>
		<span class="catItemAuthorComment">
		...
		<?php else: ?>
			...
			<a href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
				<?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?> (<?php echo $this->item->numOfComments; ?>)
			</a>
			<?php else: ?>
			<a href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
				<?php echo JText::_('Comment (0)'); ?>
			</a>
			<?php endif; ?>
		<?php endif; ?>
		</span>
