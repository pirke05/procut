...
<div class="template-description">
	<h1><?php echo "Rox BestShop";?> <span class="g4-version">v<?php echo "1.0";//$gantry->_template->getVersion();?></span></h1>
	<h2>Gantry Framework Base Theme</h2>

	<p>Rox BestShop is developed by <a href="http://www.themerox.com">ThemeRox</a> is a clean and modern e-commerce template with full responsive support with complete bootstrap featured </p>
